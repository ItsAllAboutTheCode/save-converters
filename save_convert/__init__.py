...
converter_modules: dict[str, str] = {
    ...
    "trails-of-cold-steel-iv": "save_convert.trails_of.cold_steel_iv.trails_of_cold_steel_iv_save_converter",
    "trails-into-reverie": "save_convert.trails_of.reverie.trails_into_reverie_save_converter",
}
