...
from save_convert.trails_of.cold_steel_iv.trails_of_cold_steel_iv_save_converter import (
    ...
    TRAILS_OF_COLD_STEEL_IV_PS4_SAVE_SIZE,
    add_commands,
    start_convert,
)
...
class TestConvertTrailsOfColdSteelIVSave(TestCase):
    def setUp(self):
    ...
    def test_ps4_to_pc(self):
        ...
        with (
            ...
            self.assertTrue(start_convert(test_args))
            self.assertEqual(len(test_bytes), TRAILS_OF_COLD_STEEL_IV_PS4_SAVE_SIZE)
